...
const Menu: React.FC = () => {
  ...
  const mockedRadioValuesArray = [
    { radioValue: 1, onClick: onClick, active: true },
    { radioValue: 2, onClick: onClick, active: false },
    { radioValue: 3, onClick: onClick, active: false },
    { radioValue: 4, onClick: onClick, active: false }
  ]
        ...
        <S.InfoWrapper>
          ...
          <S.QuantityWrapper>
            {mockedRadioValuesArray.map((item) => {
              <Radio key={item.radioValue} radioValue="1" onClick={onClick} checked={true} />;
            })}

            <Radio radioValue="2" onClick={onClick} checked={false} />
            <Radio radioValue="3" onClick={onClick} checked={false} />
            <Radio radioValue="4" onClick={onClick} checked={false} />
          </S.QuantityWrapper>
        </S.InfoWrapper>
        <S.InfoWrapper>
          <S.InnerWrapper>
